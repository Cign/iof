...
<div class="py-5 bg-dark">
   ...
   <section class="padding-y-100 border-bottom">
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-6">
            <h2>
                <span class="text-primary">IOF</span> offre des bourses
            </h2>
            <div class="width-4rem height-4 bg-primary rounded mt-4 marginBottom-40"></div>
            <p class="mb-5">
                En partenariat avec les écoles et Universités privées de formation à Dakar, le cabinet IOF vous offre des bourses d'étude. Ces bourses consistent en une réduction de l'ordre de 50 à 70 % des frais de scolarité annuels.
            </p>
            <ul class="list-unstyled list-style-icon list-icon-check-circle">
                <li>
                    Universités et Ecoles privées de renommée
                </li>
                <li>
   ...
   <section class="padding-y-100">
    ...
    <div class="row align-items-center">
       ...
       <div class="col-lg-6 col-sm-4">
        ...
        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSchyKYCJbmIdNJvVVjGugsgJmFo87j5G7EmI15DYq7vvCcROg/viewform?embedded=true" width="750" height="600" frameborder="0" marginheight="0" marginwidth="0">Chargement…</iframe>
        {{--
        <div class="width-4rem height-4 bg-primary rounded mt-4 marginBottom-40"></div>
        <p class="mb-5">
