...
<html lang="en">
  <head>
    ...
    <!-- Title-->
    <title>IOF, des bourses pour toutes vos formations</title>

    <!-- SEO Meta-->
    <meta name="description" content="Orientations et Bourse BAC by IOF">
    <meta name="keywords" content="Orientation, BAC, Bourses Senegal, Formation accelérée, Dakar">
    <meta name="sayotagt" content="education">
        ...
        <ul class="list-inline d-none d-lg-block mb-0">
          <li class="list-inline-item mr-3">
           <div class="d-flex align-items-center">
            ...
            <a href="mailto:iofdakar@gmail.com">Support</a>
           </div>
          </li>
          <li class="list-inline-item mr-3">
           <div class="d-flex align-items-center">
            <i class="ti-headphone mr-2"></i>
            <a href="tel:+221774341664">+221774341664</a>
           </div>
          </li>
        </ul>
    ...
    <div class="container">
      <div class="navbar p-0 navbar-expand-lg">
        <div class="navbar-brand">
          <a class="logo-default" href="index.html"><img alt="" width="157" height="70" src="assets/img/iof_globe.png"></a>
        </div>
        ...
        <div class="collapse navbar-collapse when-collapsed" id="ec-nav__collapsible">
          <ul class="nav navbar-nav ec-nav__navbar ml-auto">
              ...
              <li class="nav-item ">
                {{-- <a class="nav-link " href="#" data-toggle="dropdown">Accueil</a> --}}
              ...
              <li class="nav-item ">
                  <a class="nav-link "  href="{{route('orientation')}}">Orientations</a>
                {{-- <div class="dropdown-menu">
                    <ul class="list-unstyled">
                     <li><a class="nav-link__list" href="page-about.html">About</a></li>

                     <li class="nav-item__has-dropdown">
                        <a class="nav-link__list " href="#" data-toggle="dropdown"> Events </a>
                        <div class="dropdown-menu">
                          <ul class="list-unstyled">
                     ...
                     <li class="nav-item__has-dropdown">
                        <a class="nav-link__list " href="#" data-toggle="dropdown"> Formations accélérées </a>
                        <div class="dropdown-menu">
                          <ul class="list-unstyled">
                     ...
                     <li class="nav-item__has-dropdown">
                        <a class="nav-link__list " href="#" data-toggle="dropdown"> User </a>
                        <div class="dropdown-menu">
                          <ul class="list-unstyled">
                     ...
                     <li class="nav-item__has-dropdown">
                        <a class="nav-link__list " href="#" data-toggle="dropdown"> Notice </a>
                        <div class="dropdown-menu">
                          <ul class="list-unstyled">
                     ...
                     <li class="nav-item__has-dropdown">
                        <a class="nav-link__list " href="#" data-toggle="dropdown"> Faculty </a>
                        <div class="dropdown-menu">
                          <ul class="list-unstyled">
                     ...
                     <li class="nav-item__has-dropdown">
                        <a class="nav-link__list " href="#" data-toggle="dropdown"> Career </a>
                        <div class="dropdown-menu">
                          <ul class="list-unstyled">
              ...
              {{-- <li class="nav-item nav-item__has-dropdown">
                  <a class="nav-link " href="#" data-toggle="dropdown"> Blog </a>
                   <div class="dropdown-menu">
                    <ul class="list-unstyled">
                       ...
                       <li class="nav-item__has-dropdown">
                        <a class="nav-link__list " href="#" data-toggle="dropdown"> Layout </a>
                        <div class="dropdown-menu">
                          <ul class="list-unstyled">
                       ...
                       <li class="nav-item__has-dropdown">
                        <a class="nav-link__list " href="#" data-toggle="dropdown"> Single Post</a>
                        <div class="dropdown-menu">
                          <ul class="list-unstyled">
                ...
                <li class="nav-item ">
                    <a class="nav-link " href="{{route('formation')}}" > Formations Accélérées </a>
                </li>
              ...
              {{-- <li class="nav-item nav-item__has-megamenu">
                <a class="nav-link " href="#" data-toggle="dropdown">Elements</a>
        ...
        {{-- <div class="nav-toolbar">
          <ul class="navbar-nav ec-nav__navbar">
            <li class="nav-item nav-item__has-dropdown">
              <a class="nav-link  no-caret" href="#" data-toggle="dropdown"><i class="ti-shopping-cart"></i></a>
